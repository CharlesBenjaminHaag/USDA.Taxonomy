...
public partial class SysTableRelationship
{
    public int SysTableRelationshipId { get; set; }

    public int? SysTableFieldId { get; set; }

    public string RelationshipTypeTag { get; set; }

    public int? OtherTableFieldId { get; set; }
    ...
    public virtual SysTableField OtherTableField { get; set; }
