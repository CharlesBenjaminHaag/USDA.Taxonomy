...
public partial class ParlSiteInventory
{
    public int ParlSiteInventoryId { get; set; }

    public int InventoryId { get; set; }

    public int? SeedQuantity { get; set; }

    public int? SeedQuantityType { get; set; }
